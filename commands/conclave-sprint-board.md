...
Read and follow `${CLAUDE_PLUGIN_ROOT}/skills/conclave/visual-sprint-board/SKILL.md` for mapping and design rules. Follow these steps in order.
...
2. Read `${CLAUDE_PLUGIN_ROOT}/skills/conclave/templates/sprint-board.html.template`.
...
7. Read `${CLAUDE_PLUGIN_ROOT}/skills/conclave/templates/sprint-board-readme.template.md`, substitute `{{project}}`, `{{snapshot_iso}}`, `{{accent_source}}`, write `$REPO_ROOT/docs/sprint-board/README.md` (overwrite).
