---
title: /conclave-qa
description: Adversarially verify one or more stories against their Gherkin acceptance criteria. Structurally required. Multiple stories run in concurrent batches of ≤ 3. Runs on the integration branch (develop).
---
