...
- **Six slash commands** covering the full Day-0-to-done loop: `/conclave-init`, `/conclave-spec`, `/conclave-planning`, `/conclave-dev`, `/conclave-qa`, `/conclave-pr-review`.
...
- [Commands](/en/commands/init) — full reference for each of the six shipped slash commands.
