...
- **Seven slash commands**: six covering the full Day-0-to-done loop (`/conclave-init`, `/conclave-spec`, `/conclave-planning`, `/conclave-dev`, `/conclave-qa`, `/conclave-pr-review`), plus `/conclave-board` for a local, visual Kanban board.
...
- [Commands](/en/commands/init) — full reference for each of the seven shipped slash commands.
