...
4. **Write the standalone file** at `conclave/product/adr/ADR-NNN-<slug>.md` using `skills/conclave/templates/adr.template.md`. Fill:
   - `id: "ADR-NNN"`
   - `title: <TITLE>`
...
4. **Present candidates to the user (`AskQuestion`)**:
