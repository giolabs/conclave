...
5. **Render the PR body** using `skills/conclave/templates/pr-body.template.md`, adapting the scenario→test mapping table into a scenario→design-decision mapping table. Return this PR body text to the orchestrator.
